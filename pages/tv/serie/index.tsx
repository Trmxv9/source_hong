  ...
  return (
    <>
      ...
      <div className="flex justify-center mt-5 h-5 items-center space-x-4 text-small">
        <Button color="secondary" as={Link} href="/tv">
          Filmes
        </Button>
...
export const getServerSideProps: GetServerSideProps = async (
  ...
  if (search) {
    moviesUrl = `search/tv?api_key=${apiKey}&${apiLanguage}&query=${search}&page=${page}`;
  } else {
    if (selectedCategory) {
      switch (selectedCategory) {
        case "netflix":
          moviesUrl = `/discover/tv?air_date.lte=&certification_country=BR&page=${page}&show_me=0&sort_by=popularity.desc&vote_average.gte=0&vote_average.lte=10&vote_count.gte=0&watch_region=BR&with_watch_providers=8&with_runtime.gte=0&with_runtime.lte=400&${apiLanguage}&api_key=${apiKey}`;
          break;
        case "disney":
          moviesUrl = `/discover/tv?air_date.lte=&certification_country=BR&page=${page}&show_me=0&sort_by=popularity.desc&vote_average.gte=0&vote_average.lte=10&vote_count.gte=0&watch_region=BR&with_watch_providers=337&with_runtime.gte=0&with_runtime.lte=400&${apiLanguage}&api_key=${apiKey}`;
          break;
        case "globoplay":
          moviesUrl = `/discover/tv?air_date.lte=&certification_country=BR&page=${page}&show_me=0&sort_by=popularity.desc&vote_average.gte=0&vote_average.lte=10&vote_count.gte=0&watch_region=BR&with_watch_providers=307&with_runtime.gte=0&with_runtime.lte=400&${apiLanguage}&api_key=${apiKey}`;
          break;
        case "hbo":
          moviesUrl = `/discover/tv?air_date.lte=&certification_country=BR&page=${page}&show_me=0&sort_by=popularity.desc&vote_average.gte=0&vote_average.lte=10&vote_count.gte=0&watch_region=BR&with_watch_providers=384&with_runtime.gte=0&with_runtime.lte=400&${apiLanguage}&api_key=${apiKey}`;
          break;
        case "crunchyroll":
          moviesUrl = `/discover/tv?air_date.lte=&certification_country=BR&page=${page}&show_me=0&sort_by=popularity.desc&vote_average.gte=0&vote_average.lte=10&vote_count.gte=0&watch_region=BR&with_watch_providers=283%7C478&with_runtime.gte=0&with_runtime.lte=400&${apiLanguage}&api_key=${apiKey}`;
          break;
        default:
          break;
      }
    } else {
      moviesUrl = `tv/top_rated?api_key=${apiKey}&${apiLanguage}&page=${page}`;
    }
  }
